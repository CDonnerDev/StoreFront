...
namespace StoreFront.UI.MVC.Controllers
{
    public class ProductStatusController : Controller
    {
        ...
        public ProductStatusController(StoreFront2Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("StatusId,StatusName,StatusDescription,Discontinued")] ProductStatus productStatus)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StatusId,StatusName,StatusDescription,Discontinued")] ProductStatus productStatus)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'StoreFront2Context.ProductStatuses'  is null.");
            }
            var productStatus = await _context.ProductStatuses.FindAsync(id);
            if (productStatus != null)
            {
